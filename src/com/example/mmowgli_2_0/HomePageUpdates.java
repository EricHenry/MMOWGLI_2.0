...
public class HomePageUpdates extends CustomComponent {
	...
	private float rootButton_Ratio = 5.0f;
...
//				new Alignment(48));
		...
		toggle_rootCards.addClickListener(new NativeButton.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(rootButton_Ratio == 5.0f)
				{
					rootButton_Ratio = 40.0f;
					verticalLayout_2.setExpandRatio(verticalLayout_3, rootButton_Ratio);
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		verticalLayout_2.addComponent(verticalLayout_root);
		verticalLayout_2.setExpandRatio(verticalLayout_root, 1.0f);
	...
	private VerticalLayout buildVerticalLayout_root() {
		...
		toggle_rootCards.setHeight("20px");
		...
		verticalLayout_root.setExpandRatio(test_layout, 5.0f);
