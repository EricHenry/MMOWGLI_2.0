...
public class VideoDisplayer extends CustomComponent {
	...
	@AutoGenerated
	private Embedded embedded_BlackSwan;
...
//		myVid.setWidth("320px");
//		myVid.setHeight("265px");
//	    test_layout.addComponent(myVid);
	...
	private HorizontalLayout buildTest_layout() {
		...
		// embedded_BlackSwan
		embedded_BlackSwan = new Embedded();
		embedded_BlackSwan.setImmediate(false);
		embedded_BlackSwan.setWidth("18.75em");
		embedded_BlackSwan.setHeight("18.0em");
		embedded_BlackSwan.setSource(new ExternalResource(
				"https://www.youtube.com/watch?v=fAfRuU78X34"));
		embedded_BlackSwan.setType(1);
		embedded_BlackSwan.setMimeType("application/x-shockwave-flash");
		test_layout.addComponent(embedded_BlackSwan);
		test_layout.setExpandRatio(embedded_BlackSwan, 1.0f);
