 ...
 *
 * This class creates a container to hold and manage the CardView Components displayed in them.
 * 	The Explorer is separated into three panels, Parent, Active, and Children. This is a different
 * 	representation of a tree. This allows the user to see the context of cards.
 * 
 */
...
public class CardExplorationView extends CustomComponent {
	...
	public CardExplorationView() {
		...
		try {
			setNewChosenCard(MmowgliDB.oneCardQuery(-1));
	 ...
	 * 
	 * @param cardData		-> Which card to focus the Explorer View too
	 */
	public void setNewChosenCard(Card cardData) {
		...
		currentChosenCard = CardExplorationManager.createCardView(cardData);
	...
	/**
	 * This method takes in a list of card data and displays it to the card
	 * explorer. This method is to be explicitly used by the BestCardPath Manager
	 * 
	 * @param currentList	-> List of card data
	 * @param toDisplay		-> which view to add the card views to.
	 */
				...
				new NativeButton.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						if (!clickedCard.getCardId().equalsIgnoreCase(
							...
							// view then try to display the history
				...
				new NativeButton.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						try {
							...
							// database
							Card newCard = MmowgliDB.oneCardQuery(Integer.parseInt(clickedCard.getCardId()));
	...
	public void styleCardView(VerticalLayout view, CardView card) {
		...
		if (view.getId().equalsIgnoreCase("main")) {
			...
			//System.out.println("SET MAIN LISTENER");
	...
	public CardView getCurrentChosenCard() {
		return currentChosenCard;
	}


	public void setCurrentChosenCard(CardView currentChosenCard) {
		this.currentChosenCard = currentChosenCard;
	}
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		label_history.setValue("Parent Ideas");
		verticalLayout_2.addComponent(label_history);
		verticalLayout_2
				.setComponentAlignment(label_history, new Alignment(24));
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		label_mainTitle.setValue("Active Card");
	...
	private VerticalLayout buildVerticalLayout_4() {
		...
		label_childTitle.setValue("Child Ideas");
