...
public class CardView extends CustomComponent {
	...
	public CardView() {
		...
		button_favorite.setStyleName("cardButtons");
		
		//card text
		nativeButton_text.setCaption("Lorem ipsum dolor sit amet, consectetur adipiscing elit. "
				+ "Cras sodales eros ut ipsum ultricies eleifend. Vivamus justo ipsum, rutrum vel orci vel, "
				+ "bibendum maximus nunc. Mauris sed laoreet sem,");
		nativeButton_text.setStyleName("cardButtons");
		
		horizontalLayout_cardInfo.setStyleName("infoBar");
	}
	...
	private HorizontalLayout buildHorizontalLayout_cardLinks() {
		...
		horizontalLayout_cardLinks.addComponent(nativeButton_1);
		...
		horizontalLayout_cardLinks.addComponent(nativeButton_2);
		...
		horizontalLayout_cardLinks.addComponent(nativeButton_3);
		...
		horizontalLayout_cardLinks.addComponent(nativeButton_4);
